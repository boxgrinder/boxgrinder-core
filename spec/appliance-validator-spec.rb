    ...
    describe ".validate_hook" do
      context "repository" do
        it "should generate error when no baseurl or mirrorlist is specified for repository" do
          a = []
          @validator.validate_hook({}, OpenCascade[:name => 'Repository'], '/', a)
          a.size.should == 1
        ...
        it "should generate error when both baseurl and mirrorlist are specified for repository" do
          a = []
          @validator.validate_hook({'baseurl' => 'abc', 'mirrorlist' => 'def'}, OpenCascade[:name => 'Repository'], '/', a)
          a.size.should == 1
          a.first.message.should == 'Please specify either a baseurl or a mirrorlist.'
        end
        ...
        it "should pass if baseurl or mirrorlist is specified for repository" do
          a = []
          @validator.validate_hook({'baseurl' => 'abc'}, OpenCascade[:name => 'Repository'], '/', a)
          a.size.should == 0
        end
      end
      ...
      context "hardware" do
        it "should allow only multiplicity of 64 for memory" do
          a = []
          @validator.validate_hook({'memory' => 235}, OpenCascade[:name => 'Hardware'], '/', a)
          a.size.should == 1
        ...
        it "should pass if the memory is 256" do
          a = []
          @validator.validate_hook({'memory' => 256}, OpenCascade[:name => 'Hardware'], '/', a)
          a.size.should == 0
        end
      end
    end
